...
LAYOUT = [
    ...
    [
        sg.Button("Cancel", size=SMALL_BUTTON_SIZE),
        sg.Button(key=OPEN_CONFIG_KEY, button_text="Config", size=SMALL_BUTTON_SIZE)
    ],
    [sg.Button(key=SUBMIT_KEY, button_text="Submit", size=(SMALL_BUTTON_SIZE[0] * 2 + 1, None))],
    [sg.VPush()]
]